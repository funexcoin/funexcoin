/* src/config/funexcoin-config.h.  Generated from funexcoin-config.h.in by configure.  */
/* src/config/funexcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef FUNX_CONFIG_H

#define FUNX_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.savebitcoin.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Funexcoin"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Funexcoin 3.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "funexcoin"
