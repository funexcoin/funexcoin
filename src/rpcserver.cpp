...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Funexcoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Funexcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Funexcoin features */
        {"Funexcoin", "masternode", &masternode, true, true, false},
        {"Funexcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"Funexcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"Funexcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"Funexcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"Funexcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"Funexcoin", "startmasternode", &startmasternode, true, true, false},
        {"Funexcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"Funexcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"Funexcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"Funexcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"Funexcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"Funexcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"Funexcoin", "mnbudget", &mnbudget, true, true, false},
        {"Funexcoin", "preparebudget", &preparebudget, true, true, false},
        {"Funexcoin", "submitbudget", &submitbudget, true, true, false},
        {"Funexcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"Funexcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"Funexcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"Funexcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"Funexcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"Funexcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"Funexcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Funexcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"Funexcoin", "mnsync", &mnsync, true, true, false},
        {"Funexcoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> Funexcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:62312/\n";
}
