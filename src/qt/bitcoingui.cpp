                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Funexcoin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a FUNX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and funexcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Funexcoin"), this);
    aboutAction->setStatusTip(tr("Show information about Funexcoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Funexcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your FUNX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified FUNX addresses"));
    ...
    openAction->setStatusTip(tr("Open a funexcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Funexcoin help message to get a list with possible Funexcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Funexcoin client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Funexcoin network", "", count));
}
...
{
    QString strTitle = tr("Funexcoin"); // default title
