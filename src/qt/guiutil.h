...
/** Utility functions used by the Funexcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render FUNX addresses in monospace font
...
// Parse "funexcoin:" URI into recipient object, return true on successful parsing
