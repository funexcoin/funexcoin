...
#   c) node1 mines 32 blocks, so now node 0 has 500000FUNX, node 1 has 4250FUNX, node2 has none.
#   d) node0 sends 601 FUNX to node2, in two transactions (301 FUNX, then 300 FUNX).
