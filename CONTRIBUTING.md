Contributing to Funexcoin
==================================

The Funexcoin project operates an open contributor model where anyone is
...
The following applies to code changes to the Funexcoin project, and is not to be
confused with overall Funexcoin Network Protocol consensus changes.

Whether a pull request is merged into Funexcoin rests with the project merge
...
Patches that change Funexcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Funexcoin consensus, it must have been
...
The project leader is the release manager for each Funexcoin release.
