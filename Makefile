...
pkgdatadir = $(datadir)/funexcoin
pkgincludedir = $(includedir)/funexcoin
pkglibdir = $(libdir)/funexcoin
pkglibexecdir = $(libexecdir)/funexcoin
...
CONFIG_HEADER = $(top_builddir)/src/config/funexcoin-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/funexcoin-config.h.in \
...
ACLOCAL = ${SHELL} /media/rookie/Work/ProjectFunex/funexcoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /media/rookie/Work/ProjectFunex/funexcoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /media/rookie/Work/ProjectFunex/funexcoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /media/rookie/Work/ProjectFunex/funexcoin/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = funexcoin-cli
BITCOIN_DAEMON_NAME = funexcoind
BITCOIN_GUI_NAME = funexcoin-qt
BITCOIN_TX_NAME = funexcoin-tx
...
MAINT = 
MAKEINFO = ${SHELL} /media/rookie/Work/ProjectFunex/funexcoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
PACKAGE_NAME = Funexcoin
PACKAGE_STRING = Funexcoin 3.0.0
PACKAGE_TARNAME = funexcoin
PACKAGE_URL = 
...
abs_builddir = /media/rookie/Work/ProjectFunex/funexcoin
abs_srcdir = /media/rookie/Work/ProjectFunex/funexcoin
abs_top_builddir = /media/rookie/Work/ProjectFunex/funexcoin
abs_top_srcdir = /media/rookie/Work/ProjectFunex/funexcoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /media/rookie/Work/ProjectFunex/funexcoin/build-aux/install-sh
...
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/bitcoin1.ico \
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_funexcoin_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_funexcoin_coverage.info test_funexcoin.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Funexcoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/funexcoin-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/funexcoin-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/funexcoin-config.h
$(top_srcdir)/src/config/funexcoin-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/funexcoin-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/Funexcoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Funexcoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Funexcoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_funexcoin.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_funexcoin -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_funexcoin_filtered.info: test_funexcoin.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_funexcoin_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_funexcoin_coverage.info: baseline_filtered_combined.info test_funexcoin_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_funexcoin_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_funexcoin_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_funexcoin_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_funexcoin.coverage/.dirstamp:  test_funexcoin_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_funexcoin.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_funexcoin.coverage/ total.coverage/ $(OSX_APP)
