...
This mechanism has been integrated into Bitcore-Node-Funexcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/funexcoin/insight-api-funexcoin#web-socket-api](https://github.com/funexcoin/insight-api-funexcoin#web-socket-api)
* API: [https://github.com/funexcoin/insight-api-funexcoin#swifttx-transactions](https://github.com/funexcoin/insight-api-funexcoin#swifttx-transactions)
...
By default, the Funexcoin daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Funexcoin daemon:
