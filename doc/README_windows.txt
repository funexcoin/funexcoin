...
Intro
-----
Funexcoin (FUNX) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Funexcoin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run funexcoin-qt.exe.

Funexcoin is the original Funexcoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of Funexcoin transactions;
