...
In order to support loading of multiple wallets in funexcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is funexcoin.cpp.
...
Changes to funexcoin.cpp
----------------------
funexcoin.cpp is the entry point into funexcoin-qt, and as such, will require some minor modifications to provide hooks for
