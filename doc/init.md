Sample init scripts and service configuration for funexcoind
==========================================================
...
All three startup configurations assume the existence of a "funexcoin" user
...
setting is not set, funexcoind will shutdown promptly after startup.
...
If funexcoind is run with "-daemon" flag, and no rpcpassword is set, it will
print a randomly generated suitable password to stderr.  You can also
generate one from the shell yourself like this:

bash -c 'tr -dc a-zA-Z0-9 < /dev/urandom | head -c32 && echo'

Once you have a password in hand, set rpcpassword= in /etc/funexcoin/funexcoin.conf

For an example configuration file that describes the configuration settings,
see contrib/debian/examples/funexcoin.conf.
...
PID file:            /var/run/funexcoind/funexcoind.pid (OpenRC and Upstart)
                     /var/lib/funexcoind/funexcoind.pid (systemd)

The configuration file, PID directory (if applicable) and data directory
should all be owned by the funexcoin user and group.  It is advised for security
reasons to make the configuration file and data directory only readable by the
funexcoin user and group.  Access to funexcoin-cli and other funexcoind rpc clients
...
setting the FunexcoinD and FLAGS environment variables in the file
